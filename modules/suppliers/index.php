...
<div class="card filter-card p-3 mb-4" data-filter-chips="1">
    <form method="get" class="row g-2 align-items-end">
        ...
        <div class="col-auto">
            ...
            <a href="/modules/suppliers/index.php" class="btn btn-sm btn-outline-secondary">Clear</a>
        </div>
    </form>
</div>
...
<div class="card p-4">
    ...
    <?php
    render_pagination('/modules/suppliers/index.php', $page, $totalPages, $totalCount, $perPage, 'supplier');
        ?>
</div>
