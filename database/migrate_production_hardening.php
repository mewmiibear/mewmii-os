 ...
 * (https://yourdomain/database/migrate_production_hardening.php) or CLI
 * (`php database/migrate_production_hardening.php`) against an EXISTING Mewmii OS
 ...
 * didn't get moved first. Unique to this migration - not shared with any other file.
 */
...
function migrate_production_hardening(PDO $pdo): array
{
...
if (!defined('MIGRATE_RUNNER_ACTIVE')) {
    migrate_production_hardening(app_db());
}
