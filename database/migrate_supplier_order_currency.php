 ...
 *
 * Run once via browser (https://yourdomain/database/migrate_supplier_order_currency.php) or
 * CLI (`php database/migrate_supplier_order_currency.php`) against an EXISTING Mewmii OS
