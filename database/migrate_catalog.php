 ...
 * (https://yourdomain/database/migrate_catalog.php) or CLI
 ...
 * column. Unique to this migration - not shared with any other file.
 */
...
function migrate_catalog(PDO $pdo): array
{
